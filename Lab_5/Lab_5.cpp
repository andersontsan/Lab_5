...
int main()
{
    ...
    for (char character : text) {
        if (character >= 65 && character <= 90) { //capital letter
            ...
            char upperCaseLetter = character - 32; //convert to upper case number
            int upperCaseCode = upperCaseLetter - 65; //get upper case code
            char translatedLetter = intVector[upperCaseCode];
            char lowerCaseLetter = intVector[upperCaseCode] + 32; //convert back to lowercase
